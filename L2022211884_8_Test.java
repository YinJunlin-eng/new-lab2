...
public class L2022211884_8_Test {
     ...
     * 测试用例: 4x5网格，期望结果为3
     *
     * 该测试用例验证了多个岛屿的情况，确保算法能够正确识别并计数每个岛屿。
     */
    @Test
     ...
     *
     * 该测试用例验证了输入为全水域网格时，算法能够正确返回0个岛屿。
     */
    @Test
     ...
     *
     * 该测试用例验证了输入为一个完整岛屿时，算法能够正确返回1个岛屿。
     */
    @Test
     ...
     * 测试用例: 1x5的网格，期望结果为3
     *
     * 该测试用例验证了输入为一行的网格时，算法能够正确计数岛屿数量。
     */
    @Test
     ...
     * 测试用例: 5x1的网格，期望结果为3
     *
     * 该测试用例验证了输入为一列的网格时，算法能够正确计数岛屿数量。
     */
    @Test
